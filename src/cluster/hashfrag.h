...
/**
 * \brief Basic Hash Fragment
 *
 * \warning without Replication, Fault Tolerance and Repair
 */
...
public:
  ...
  /**
   * \warning number of nodes should be setted by master
   */
...
template <class Key> inline BasicHashFrag<Key> &global_hashfrag() {
