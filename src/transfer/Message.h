...
/**
 * \warning every MessageMeta should have a message_class
 */
...
/**
 * a C++ class wrapper for ZMQ message
 */
class Message {
public:
...
/**
 * Request is an upper wrapper for data.
 *
 * It is a direct API for user's data, the data is wrappered with a `Request` ,
 * then the `request` will be transformed to a `Package` ,
 * the package will be sent by ZMQ.
 *
 */
struct Request {
   ...
   * or a response from the receiver
   */
